...
DEBUG = False
'''
    Если константа DEBUG отключена(False), 
    то мы можем настраивать handler и
...
TEMPLATES = [
    {
        ...
        'DIRS': [],  # Нестандартные пути к файлам шаблонов
        'APP_DIRS': True,  # Ищет внутри приложений каталога templates
        'OPTIONS': {
            'context_processors': [
